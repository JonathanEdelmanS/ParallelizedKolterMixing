...
# ╔═╡ eac8b30d-505a-4539-837b-476f9b926099
using LinearAlgebra, Random, JuMP, SCS, SparseArrays, Plots


# ╔═╡ 5950d5f0-e1f2-472b-ac4c-361c208bb9a7
using CUDA

# ╔═╡ 65ad7e8b-1137-4611-b0d8-35e349f09f28
begin
    n=200
    k=9
...
# ╔═╡ e119c3c8-159c-4e8b-a094-00d2b45f392b
C_gpu = CuArray(C)
...
# ╔═╡ 6a0f3fc1-4507-4f0c-8925-74079c25fc53
# ╠═╡ disabled = true
#=╠═╡
@benchmark C*C
  ╠═╡ =#

# ╔═╡ bd18d0cb-cd90-470f-a95c-eb5689d82571
...
# ╔═╡ ec8f31a1-2cca-4dee-a660-4ce9d882d7b9
begin
...
# ╔═╡ 9ba792a4-ce3e-4161-857b-331b89004e15


# ╔═╡ 67756d00-2a66-4e49-b9af-e96fd9da5af7
preRand = rand(1:n,n*k*2*4)

# ╔═╡ 48563a67-1586-4844-acab-b3a3ea76adb6


# ╔═╡ f9ce4585-b551-4c0a-a6f8-d2a9e824ca20


# ╔═╡ f3baff67-f55d-4031-89d1-480010371ec2
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ 331c298e-1779-4332-85da-c48328af7c56
# ╠═╡ disabled = true
#=╠═╡
@btime randparallel(n,k,C)
  ╠═╡ =#

# ╔═╡ 2f01da65-5130-4dac-bcfc-53efecdc150a


# ╔═╡ 885b517d-e5f3-43ed-bde1-d0f007bf8e27


# ╔═╡ 6d7bc1ed-64d4-4032-ba92-951a3cee8e5e


# ╔═╡ 26e6e9de-15fb-4e1c-b261-7462b3940285
# ╠═╡ disabled = true
#=╠═╡
@time randGPU(n,k,C_gpu)
  ╠═╡ =#

# ╔═╡ 238be92f-e1ae-4252-88c2-7597c91f1fdd
begin
	function JuMPspeed()
...
# ╔═╡ 5837184b-1775-4bb7-adc3-e3ee63fd191b
Threads.nthreads()

# ╔═╡ 24105372-70c6-419e-a426-0e1a761efefc
eigen(trueSol).values[193:200]

# ╔═╡ da2f2ec6-9b5a-45b5-b78f-34944ec40117


# ╔═╡ bd8e1a7b-053a-4c7f-bfbd-bda809c47f0e
sum(trueSol.*C)

# ╔═╡ e035c56b-132c-4cef-91b2-66540daae1a6


# ╔═╡ 113f99d3-27f7-4084-9f4c-0f60eeff0f45
rank(trueSol)

# ╔═╡ 501d3c3d-32ae-45d7-bc96-970c48632f99
function Cn(n)
	c = Symmetric(round.(rand(n,n))) 
    return (c  - I + abs.(c-I))/2 
end

# ╔═╡ 11e0cb7e-1b2e-47ee-a664-dc5ac388f3c8
begin
...
# ╔═╡ aebc3dca-d890-4819-ae34-424a79740db3
k

# ╔═╡ 8b6bd92f-0657-42fe-b73c-a19165ec3aa2
@btime randparallel(n,k,C)

# ╔═╡ 855fdd0a-3e85-425d-bbbc-b85035e9e929
@btime randserial(n,k,C)

# ╔═╡ 53021234-17fe-4c12-9d61-330cb0c76306
Threads.nthreads()

# ╔═╡ 49252d03-e1ac-4062-a778-adb699e97a05
@time solved = JuMPspeed()

# ╔═╡ 013357d6-2f17-4314-ac39-c9b92665cf79
sum(C.*solved)

# ╔═╡ bac51131-4374-49a5-a7fa-40fe6d3dc24a
begin
...
# ╔═╡ 3971c031-b833-46e5-84d2-ab015786316e
scatter(ks, kdouble, xaxis = "k", yaxis = "time(s)", legend=false)

# ╔═╡ 608c80a6-2123-4282-b175-77780206af91
scatter(ns, ndouble, xaxis = "n", yaxis = "time (s)", legend=false )


# ╔═╡ a036d10e-b02c-4a97-9adb-95c60cc61397


# ╔═╡ 63811a6e-2a1f-45ad-acea-3eeb17e9a0d5


# ╔═╡ d0b84d2d-82e8-45e4-bc75-e28615feb4ec
begin
...
# ╔═╡ d5079903-d9e3-484b-ae4c-2ab7ea9d45ef
begin
...
# ╔═╡ 69038e73-d652-425d-8e09-4ca5087200df
begin
JuMPns = [50, 100, 200, 300]
JuMPtimes = [.232 ,1.29 ,9.54, 29.57]
end

# ╔═╡ b3b66862-5f49-4950-8285-477a7d6e5695
scatter(JuMPns, JuMPtimes, xlabel = "n", ylabel = "time (s)",  legend=false)

# ╔═╡ 70281279-1a95-4e74-87ec-531832a9f080
@time randserial(n,18,Cn(n))

# ╔═╡ 9f780b42-7318-45d4-b72d-fb8da3943dde
@time randserial(n,36,Cn(n))

# ╔═╡ 9d51b175-f086-43d8-be56-ef7e3c7dd915
@time randserial(n,8,Cn(n))

# ╔═╡ 045bd18e-d883-4d2a-a02c-fc54eba8e6ee
BLAS.set_num_threads(1)

# ╔═╡ 4d08f75d-e093-4c49-ab1a-c79903348aa3
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "79d30614dc5a92433ed7cfaace71df008dc42d87"
